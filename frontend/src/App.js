...
const App = () => {
    ...
    return (_jsx(Box, { sx: { minHeight: '100vh', backgroundColor: 'background.default' }, children: _jsx(Container, { maxWidth: "lg", sx: { py: 4 }, children: _jsxs(Stack, { spacing: 4, children: [_jsxs(Stack, { spacing: 1, children: [_jsxs(Stack, { direction: { xs: 'column', sm: 'row' }, spacing: 2, alignItems: { xs: 'stretch', sm: 'center' }, justifyContent: "space-between", children: [_jsx(Typography, { variant: "h4", fontWeight: 700, children: "PBS Biologics Lookup" }), _jsx(Box, { sx: {
