...
export const FiltersPanel = () => {
    ...
    return (_jsx(Paper, { elevation: 0, variant: "outlined", sx: { p: 2.5 }, children: _jsxs(Stack, { spacing: 2.5, children: [_jsxs(Stack, { direction: { xs: 'column', md: 'row' }, spacing: 2, children: [_jsxs(Stack, { flex: 1, spacing: 1, sx: { minWidth: 0 }, children: [_jsx(Typography, { variant: "subtitle2", color: "text.secondary", children: "Schedule" }), _jsx(ScheduleSelect, {})] }), _jsxs(Stack, { flex: 1, spacing: 1, sx: { minWidth: 0 }, children: [_jsx(Typography, { variant: "subtitle2", color: "text.secondary", children: "Drug" }), _jsx(MultiFilter, { label: "Drug", placeholder: "All drugs", options: drugsQuery.data ?? [], value: drug, onChange: (values) => handleFilterChange('drug', values), loading: drugsQuery.isLoading })] }), _jsxs(Stack, { flex: 1, spacing: 1, sx: { minWidth: 0 }, children: [_jsx(Typography, { variant: "subtitle2", color: "text.secondary", children: "Brand" }), _jsx(MultiFilter, { label: "Brand", placeholder: "All brands", options: brandsQuery.data ?? [], value: brand, onChange: (values) => handleFilterChange('brand', values), loading: brandsQuery.isLoading })] })] }), _jsxs(Stack, { direction: { xs: 'column', md: 'row' }, spacing: 2, children: [_jsxs(Stack, { flex: 1, spacing: 1, sx: { minWidth: 0 }, children: [" ", _jsx(Typography, { variant: "subtitle2", color: "text.secondary", children: "Indication" }), _jsx(MultiFilter, { label: "Indication", placeholder: "All indications", options: indicationsQuery.data ?? [], value: indication, onChange: (values) => handleFilterChange('indication', values), loading: indicationsQuery.isLoading })] }), _jsxs(Stack, { flex: 1, spacing: 1, sx: { minWidth: 0 }, children: [_jsx(Typography, { variant: "subtitle2", color: "text.secondary", children: "Formulation" }), _jsx(MultiFilter, { label: "Formulation", placeholder: "All formulations", options: formulationsQuery.data ?? [], value: formulation, onChange: (values) => handleFilterChange('formulation', values), loading: formulationsQuery.isLoading })] }), _jsxs(Stack, { flex: 1, spacing: 1, sx: { minWidth: 0 }, children: [_jsx(Typography, { variant: "subtitle2", color: "text.secondary", children: "Treatment phase" }), _jsx(MultiFilter, { label: "Treatment phase", placeholder: "All phases", options: treatmentPhasesQuery.data ?? [], value: treatmentPhase, onChange: (values) => handleFilterChange('treatmentPhase', values), loading: treatmentPhasesQuery.isLoading })] })] }), _jsxs(Stack, { direction: { xs: 'column', md: 'row' }, spacing: 2, children: [_jsxs(Stack, { flex: 1, spacing: 1, children: [_jsx(Typography, { variant: "subtitle2", color: "text.secondary", children: "Hospital type" }), _jsx(MultiFilter, { label: "Hospital type", placeholder: "All hospital types", options: hospitalTypesQuery.data ?? [], value: hospitalType, onChange: (values) => handleFilterChange('hospitalType', values), loading: hospitalTypesQuery.isLoading })] }), _jsxs(Stack, { flex: 1, spacing: 1, children: [_jsx(Typography, { variant: "subtitle2", color: "text.secondary", children: "PBS Code" }), _jsx(MultiFilter, { label: "PBS Code", placeholder: "All PBS codes", options: pbsCodesQuery.data ?? [], value: pbsCode, onChange: (values) => handleFilterChange('pbsCode', values), loading: pbsCodesQuery.isLoading })] })] }), _jsxs(Stack, { direction: { xs: 'column', md: 'row' }, spacing: 2, alignItems: "flex-end", children: [_jsx(Box, { flex: 1 }), _jsx(Divider, { flexItem: true, orientation: "vertical", sx: { display: { xs: 'none', md: 'block' } } }), _jsx(Button, { variant: "text", onClick: handleResetFilters, sx: { alignSelf: { xs: 'stretch', md: 'center' } }, children: "Reset filters" })] })] }) }));
};
